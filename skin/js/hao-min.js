...
$(document).ready(function () {
    var accordion_head = $(".left-nav > li .open"), accordion_body = $(".left-nav li  ul");
...
$(document).ready(function () {
    $(".panel-body dt a").click(function () { return false })
});
(function ($, h, i, j) {
    var k = "easyTicker", defaults = { direction: "up", easing: "swing", speed: "slow", interval: 2000, height: "auto", visible: 0, mousePause: 1, controls: { up: "", down: "", toggle: "", playText: "Play", stopText: "Stop" } };
    function EasyTicker(f, g) {
        ...
        $([h, i]).off("focus.jqet").on("focus.jqet", function () {
            s.winFocus = 1
        }).off("blur.jqet").on("blur.jqet", function () { s.winFocus = 0 });
        ...
        function init() {
            ...
            s.elem.css({
                position: "relative", height: s.opts.height, overflow: "hidden"
            });
            s.targ.css({
        ...
        s.timer = setInterval(function () { if (s.winFocus == 1) { move(s.opts.direction) } }, s.opts.interval);
            ...
            if (s.opts.height == "auto" && s.opts.visible != 0) {
                ...
                if (s.opts.height == "auto") { fullHeight() }
            }
...
$(function () {
    $(".slogan").easyTicker({ visible: 1, interval: 3000 })
});
+function ($) {
    ...
    Tab.prototype.activate = function (element, container, callback) {
        ...
        function next() {
            ...
            } if (element.parent(".dropdown-menu")) { element.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded", true) } callback && callback()
    ...
    $(document).ready(function () {
        ...
        function getPresets() {
            ...
            return [{
                id: 60001, name: "知乎", url: "http://www.zhihu.com",
            },
            {
                id: 60002, name: "网易公开课", url: "http://open.163.com",
            },
            {
                id: 60003, name: "友道词典", url: "http://dict.youdao.com",
            },
            {
                id: 60004, name: "今日头条", url: "http://toutiao.com",
            },
            {
                id: 60005, name: "cnBeta", url: "http://www.cnbeta.com",
            },
            {
                id: 60006, name: "QQ 邮箱", url: "https://mail.qq.com",
            },
            {
                id: 60007, name: "Bilibili", url: "http://www.bilibili.com",
            },
            {
                id: 60008, name: "网易云音乐", url: "http://music.163.com",
            },
            {
                id: 60009, name: "weibo", url: "https://weibo.com",
            }]
        }
        ...
        function setStore(items) {
            ...
            var item = { name: this.getAttribute("data-name"), url: this.href, };
            addRecentItem(item);
            initRecentItems()
            ...
            fm.toggle("fast", function () { try { fm.find("input").eq(0).focus() } catch (err) { } })
        });
        ...
        function createSort() {
            return Sortable.create(myList, {
                group: "localStorage-my-link", animation: 150, store: {
        ...
        function markLinks() {
            $markLinks.each(function () { this.addEventListener("click", onClickAllLink) })
        } function onClickAllLink(e) {
            var item = { name: this.querySelector(".link-title").textContent, url: this.href, };
            addRecentItem(item);
            initRecentItems()
        } markLinks()
    })
